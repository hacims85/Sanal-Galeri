...
{
    public partial class AddArtCategories : System.Web.UI.Page
    {
        ...
        protected void lbtn_addArtCategories_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(tb_addArtCategories.Text.Trim()))
            {
                if (dm.dataControl("ArtCategories", "Name", tb_addArtCategories.Text.Trim()))
                {
                    ...
                    ac.ArtCategoriesStatus = true;
                    if (dm.AddArtCategories(ac))
                    {
                        pnl_successful.Visible = true;
                        pnl_unsuccessful.Visible = false;
                        tb_addArtCategories.Text = "";
                    }
                    else
                    {
